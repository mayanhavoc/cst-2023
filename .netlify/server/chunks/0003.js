...
const _0003 = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<h2>¿Qué es un <em>blockchain</em>?</h2>
...
<hr>
<h2>¿Qué es un mecanismo de consenso?</h2>
...
<h3>¿Qué es el protocolo de Prueba de Participación o <em>Proof of Stake</em>?</h3>
...
<h4>¿Qué es un <em>stake pool</em>?</h4>
...
<h4>El <em>staking</em> y la delegación</h4>
